-- CORRECTED Kenal Admin Dashboard Views
-- Based on actual column structure found in existing working queries
...
-- Recent Users View (using actual column names)
